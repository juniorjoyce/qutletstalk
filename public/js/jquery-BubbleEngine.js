(function($){
  $.fn.extend({
    BubbleEngine: function(options) {
      ...
      this.popDem = function() {
        div.attr("src", options.imgSource1);
      };
      ...
      function GenerateElement(){
        ...
        div.hover(function() {
          ...
          div.attr("src", options.imgSource1);
          div.css({
          top:      options.particleSourceY - (particleSize/10),
          left:     options.particleSourceX + (particleSize/10),
          width:    particleSize*1.1,
          height:   particleSize*1.1
          });
          setTimeout(
            function(){
              div.remove()
